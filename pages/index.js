      ...
      <main className={styles.main}>
        ...
        <div className={styles.grid}>
          ...
          <div className={styles.card}>
            ...
            <ul>
              <li>Building my portfolio with <a href="https://nextjs.org/" target="_blank" rel="noreferrer">Nextjs</a> and <a href="https://firebase.google.com/" target="_blank" rel="noreferrer">Firebase</a></li>
          ...
          <div className={`${styles.card} ${styles['card--fullwidth']}`}>
            ...
            <p className={styles.socials}>
              <a href="https://www.linkedin.com/in/laurent-bourget-91b086143/" rel="noreferrer" title="Contact me on LinkedIn">
              ...
              <a href="https://github.com/HeavenSwordz/" rel="noreferrer" title="Checkout my GitHub">
